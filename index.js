...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:dark\n' // Nama kamu
            + 'ORG:Pepyto;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5519999897566:+5519999897566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[â] ESTE PEDIDO Ã ESPECÃFICO PARA USUARIO MOD minatin BOT*',
					...
					userB: `â1¤7â1¤7ã1¤7 LISTA ãââ1¤7\nOlÃ¡ Kak !\nDesculpe, irmÃ£. VocÃª nÃ£o estÃ¡ registrado como amigo de Minatin. Registre-se para fazer amizade com o bot Minatin por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Minatin|17\n\nâ1¤7â1¤7ã1¤7 Minatin BOT ãââ1¤7`,
...
case 'cep1':
			        ...
			        base1 = `ð Minaton CONSULTAS / BASE 1 ð
...
//fim comandos dark				   
				...
				case 'premiumlist':
					...
					teks += `â1¤7+ Total : ${premium.length}\nâ°ââ1¤7â1¤7â1¤7â1¤7â1¤7*ã1¤7 *MinatinBOT* ã1¤7*â1¤7â1¤7â1¤7â1¤7`
...
case 'base1':
			        ...
			        base1 = `ð Minatin CONSULTAS / BASE 1 ð
...
ð BY: Minatin BOT `
			        ...
			        base2 = `ð Minatin CONSULTAS / BASE 2 ð
...
ð BY: Minatin BOT `
                ...
                case 'base3':
			        ...
			        base3 = `ð Minatin CONSULTAS / BASE 3 ð
...
ð BY: Minatin BOT `
			        ...
			        base4 = `ð Minatin CONSULTAS / BASE 4 ð
...
ð BY: Minatin BOT `
                ...
                case 'base5':
			        ...
			        base5 = `ð Minatin CONSULTAS / BASE 5 ð
...
ð BY: Minatin BOT `
                ...
                case 'base6':
			        ...
			        base6 = `ð Minatin CONSULTAS / BASE 6 ð
...
ð BY: Minatin BOT `
                ...
                case 'dono1':
                    ...
                    dark = `â1¤7 NOME: ${anu.nome}\nâ1¤7 NUMERO: ${anu.numero}\nâ1¤7 SEXO: ${anu.sexo}\nâ1¤7 NICK: ${anu.nick}\nâ1¤7 YT: ${anu.yt}\nâ1¤7 INSTA: ${anu.insta}`
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`â­ââ1¤7â1¤7â1¤7*ã1¤7 *TOTAL DE USUÃRIOO Minatin BOT ð* ã\n\`\`\``
					no = 0
...
// recursos anime, random @minatin domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*minatin domina â1¤7*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*â­ââ1¤7â1¤7â1¤7*ã1¤7 *PREMIUM USERð* ã\n*â1¤7+ wa.me/5517988058041*â°ââ1¤7â1¤7â1¤7â1¤7â1¤7*ã1¤7 *Minatin* ã1¤7*â1¤7â1¤7â1¤7â1¤7*\n\n*_SE QUER SER UM USUÃRIO PREMIUM DO Minatin BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* ðð¨ððð¦ â\n*YOUTUBE:* https://bit.ly/2MD43V2\n*WPP:* wa.me/+5517988058041\n*INSTA:* @lucas__viniicius_\n\n\nEspero que tenham gostado do bot ðð©ï¸1¤7'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
