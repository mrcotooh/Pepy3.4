...
const { gui } = require('./src/menus/gui')
const { figumenu } = require('./src/menus/figumenu')
		...
		try {
			...
			mess = {
				...
				only: {
					...
					premium: '[🔒] ESTE PEDIDO Ã SO PARA *USUÃRIOS PREMIUMS*',
					mod: '[🔒] ESTE PEDIDO Ã ESPECÃFICO PARA USUARIO MOD Pepyto BOT*',
					...
					userB: `Desculpe, irmã. Você não está registrado como amigo de Pepy. Registre-se para fazer amizade com o bot Pepyto por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Pepy\n\n-------------------Pepy Bot------------------ `,
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Nesse grupo, não gostamos de racismos, que isso sirva de exemplo ð¶")
		}, 4000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("2 segundos")
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo KKKKKKKK tchau otário ðð¤")
		}, 0)
	}
...
//msc fim
			...
			switch(command) {
				...
				case 'menu':
					...
					break
					case 'dono':
					client.sendMessage(from, gui(prefix), text)
					break
				case 'interativo':
					...
					break
					case 'figumenu':
					client.sendMessage(from, figumenu(prefix), text)
					break
					case 'videos':
...
//GEMBOK TEXT
            ...
            case 'bodoh':
				...
				case 'hunti':
                 ...
                 case 'setdesc':
				     ...
				     client.sendMessage(from, 'DescriÃ§ão alterada com sucesso', text, {quoted: mek})
				     break
			case 'google':
		...
		case 'halloweentext':
         ...
         case 'moddroid':
			...
			hepi = data.result[0] 
			teks = `*Nome*: ${data.result[0].title}\n*editor*: ${hepi.publisher}\n*mod info:* ${hepi.mod_info}\n*Tamanho*: ${hepi.size}\n*Ãºltima versão*: ${hepi.latest_version}\n*gênero*: ${hepi.genre}\n*link:* ${hepi.link}\n*download*: ${hepi.download}`
...
ð BY: Pepyto BOT `
                ...
                case 'wikin':
                    ...
                    client.sendMessage(from, anu, image, { quoted: mek, caption: '*InformaÃ§Ãµes logo abaixo *'})
...
🏮 *FONTE*: ${anu.slug}`
 ...
 🏮 *DATA SITUAÃÃO:* ${res.data_situacao}
 🏮 *TIPO:* ${res.tipo}
 🏮 *NOME:* ${res.nome}
 🏮 *UF:* ${res.uf}
 🏮 *TELEFONE:* ${res.telefone}
 🏮 *SITUAÃÃO:* ${res.situacao}
 🏮 *BAIRRO:* ${res.bairro} 
 🏮 *RUA:* ${res.logradouro}
 🏮 *NÃMERO:* ${res.numero}
 🏮 *CEP :* ${res.cep}
 🏮 *MUNICÃPIO:* ${res.municipio}
 🏮 *PORTE:* ${res.porte}
 🏮 *ABERTURA:* ${res.abertura}
 🏮 *NATUREZA JURÃDICA:* ${res.natureza_juridica}
 🏮 *FANTASIA:* ${res.fantasia}
 🏮 *CNPJ:* ${res.cnpj}
 🏮 *ÃLTIMA ATUALIZAÃÃO:* ${res.ultima_atualizacao}
 🏮 *STATUS:* ${res.status}
...
break
		   ...
		   await limitAdd(sender)
				...
				case 'meme':
					...
					ze =  ri[Math.floor(Math.random() * ri.length)];
					nye = await getBuffer(ze)
					client.sendMessage(from, nye, image, { caption: 'hoje eu tou comédianteï¸1¤7', quoted: mek })
					await limitAdd(sender) 	
					break 
			    case 'kbbi':
...
break
			    ...
			    case 'nsfwblowjob':
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Não faÃ§a ingredientes para o tio comum'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('🚫 *ERRO* 🚫')
					}
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from,`*AtenÃ§ão, antilink esta ativo, qualquer um que nao for adm mandar link, sera expulso do gp imediatamente.*`, text)
					} else if (Number(args[0]) === 0) {
				...
				case 'wibu':
					...
					wibu = ` 🏮 *nome* ${anu.result.nama} 🏮 *descriÃ§ão* ${anu.result.deskripsi}`
...
// recursos anime, random @Pepyto domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Pepyto domina *'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('82387804410')) return reply('Falha ao ligar para o nÃºmero do proprietário')
                ...
                case 'blowjob':
					...
					break
				case 'bloqueados':
					teks = 'Esta é a lista de nÃºmeros bloqueados :\n'
				...
				case 'neko':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'â­ââ1¤7â1¤7â1¤7ã1¤7 *PREMIUMð* ãââ1¤7*\nâ1¤7+ *NÃºmero* : \nâ1¤7+ *Status*: *DEATIVO*\nâ1¤7 Te vejo para o próximo pedidoð\n*â°ââ1¤7â1¤7â1¤7â1¤7â1¤7ã1¤7 *posiÃ§ão* ãââ1¤7â1¤7â1¤7'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
				...
				case 'termux':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Terminal é um programa muito conhecido no mundo das distribuiÃ§ÃµesÂ Linux. Ele é uma ferramenta que facilita muito nas tarefas relacionadas ao sistema. Agora, já pensou emÂ utilizar oÂ Terminal LinuxÂ no seuÂ Android? Esta é a proposta doÂ Termux.\n\n*TERMUX: UTILIZE O TERMINAL NO SEU ANDROID*\n\nA utilizaÃ§ão do TerminalÂ aumenta muito a produtividadeÂ do usuário que já possui um determinado nÃ­vel de conhecimento técnico.\nCom o terminal, é possÃ­vel fazer diversas e diferentes coisas, desde navegar entre os diretórios e instalar programas, até descompactar arquivos e monitorar os processos.'})
					break
		    	case 'grupoinfo':
                    client.updatePresence(from, Presence.composing)
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'tiktokstalk':
					try {
						...
						console.log(`Error :`, color(e,'red'))
						reply('PossÃ­vel nome de usuário inválido')
					}
					break
				case 'nulis':
				case 'tulis':
			...
			reply(mess.wait)
                ...
                case 'marcar2':
                 ...
                 case 'marcar3':
					...
					break
				case 'limpar':
					if (!isOwner) return reply('Quem é Você?, Voce não é meu dono ð')
					...
					break
				case 'bc':
					if (!isOwner) return reply('Quem é Você, você não é meu dono ð?')
        ...
        case 'promover':
				...
				case 'add':
					...
					if (args[0].startsWith('08')) return reply('Use o código do pais, man')
					try {
